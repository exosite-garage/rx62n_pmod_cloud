...
#define ST7579_CS_PIN_OUT	 R_IO_PORT_Set(LCD_CS, PDL_IO_PORT_OUTPUT)
#define ST7579_CS_LOW		 R_IO_PORT_Write(LCD_CS, 0)
#define ST7579_CS_HIGH		 R_IO_PORT_Write(LCD_CS, 1)

#define ST7579_RS_PIN_OUT	 R_IO_PORT_Set(LCD_A0, PDL_IO_PORT_OUTPUT)
#define ST7579_RS_LOW        R_IO_PORT_Write(LCD_A0, 0)
#define	ST7579_RS_HIGH	     R_IO_PORT_Write(LCD_A0, 1)

#define ST7579_RESET_PIN_OUT R_IO_PORT_Set(LCD_RESET, PDL_IO_PORT_OUTPUT)
#define ST7579_RESET_LOW	 R_IO_PORT_Write(LCD_RESET, 0)
#define ST7579_RESET_HIGH	 R_IO_PORT_Write(LCD_RESET, 1)

#define MOSIA_PIN_OUT		 R_IO_PORT_Set(RSPI_MOSI, PDL_IO_PORT_OUTPUT)
#define MISOA_PIN_IN		 R_IO_PORT_Set(RSPI_MISO, PDL_IO_PORT_INPUT)
